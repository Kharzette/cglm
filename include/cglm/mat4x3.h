...
CGLM_INLINE
void
glm_mat4x3_copy(const mat4x3 mat, mat4x3 dest) {
  dest[0][0] = mat[0][0];
  dest[0][1] = mat[0][1];
  dest[0][2] = mat[0][2];
...
CGLM_INLINE
void
glm_mat4x3_mul(const mat4x3 m1, const mat3x4 m2, mat3 dest) {
...
CGLM_INLINE
void
glm_mat4x3_mulv(const mat4x3 m, const vec4 v, vec3 dest) {
...
CGLM_INLINE
void
glm_mat4x3_transpose(const mat4x3 m, mat3x4 dest) {
  dest[0][0] = m[0][0];
  dest[0][1] = m[1][0];
  dest[0][2] = m[2][0];
  dest[0][3] = m[3][0];
