...
CGLM_INLINE
void
glm_ivec2(const int * __restrict v, ivec2 dest) {
  dest[0] = v[0];
  dest[1] = v[1];
}
...
CGLM_INLINE
int
glm_ivec2_dot(const ivec2 a, const ivec2 b) {
...
CGLM_INLINE
int
glm_ivec2_cross(const ivec2 a, const ivec2 b) {
...
CGLM_INLINE
void
glm_ivec2_add(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] = a[0] + b[0];
  dest[1] = a[1] + b[1];
}
...
CGLM_INLINE
void
glm_ivec2_adds(const ivec2 v, int s, ivec2 dest) {
  dest[0] = v[0] + s;
  dest[1] = v[1] + s;
}
...
CGLM_INLINE
void
glm_ivec2_sub(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] = a[0] - b[0];
  dest[1] = a[1] - b[1];
}
...
CGLM_INLINE
void
glm_ivec2_subs(const ivec2 v, int s, ivec2 dest) {
  dest[0] = v[0] - s;
  dest[1] = v[1] - s;
}
...
CGLM_INLINE
void
glm_ivec2_mul(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] = a[0] * b[0];
  dest[1] = a[1] * b[1];
}
...
CGLM_INLINE
void
glm_ivec2_scale(const ivec2 v, int s, ivec2 dest) {
  dest[0] = v[0] * s;
  dest[1] = v[1] * s;
}
...
CGLM_INLINE
void
glm_ivec2_div(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] = a[0] / b[0];
  dest[1] = a[1] / b[1];
}
...
CGLM_INLINE
void
glm_ivec2_divs(const ivec2 v, int s, ivec2 dest) {
  dest[0] = v[0] / s;
  dest[1] = v[1] / s;
}
...
CGLM_INLINE
void
glm_ivec2_mod(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] = a[0] % b[0];
  dest[1] = a[1] % b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_addadd(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] += a[0] + b[0];
  dest[1] += a[1] + b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_addadds(const ivec2 a, int s, ivec2 dest) {
  dest[0] += a[0] + s;
  dest[1] += a[1] + s;
}
...
CGLM_INLINE 
void 
glm_ivec2_subadd(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] += a[0] - b[0];
  dest[1] += a[1] - b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_subadds(const ivec2 a, int s, ivec2 dest) {
  dest[0] += a[0] - s;
  dest[1] += a[1] - s;
}
...
CGLM_INLINE 
void 
glm_ivec2_muladd(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] += a[0] * b[0];
  dest[1] += a[1] * b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_muladds(const ivec2 a, int s, ivec2 dest) {
  dest[0] += a[0] * s;
  dest[1] += a[1] * s;
}
...
CGLM_INLINE 
void 
glm_ivec2_maxadd(const ivec2 a, const ivec2 b, ivec2 dest) {
...
CGLM_INLINE 
void 
glm_ivec2_minadd(const ivec2 a, const ivec2 b, ivec2 dest) {
...
CGLM_INLINE 
void 
glm_ivec2_subsub(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] -= a[0] - b[0];
  dest[1] -= a[1] - b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_subsubs(const ivec2 a, int s, ivec2 dest) {
  dest[0] -= a[0] - s;
  dest[1] -= a[1] - s;
}
...
CGLM_INLINE 
void 
glm_ivec2_addsub(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] -= a[0] + b[0];
  dest[1] -= a[1] + b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_addsubs(const ivec2 a, int s, ivec2 dest) {
  dest[0] -= a[0] + s;
  dest[1] -= a[1] + s;
}
...
CGLM_INLINE 
void 
glm_ivec2_mulsub(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] -= a[0] * b[0];
  dest[1] -= a[1] * b[1];
}
...
CGLM_INLINE 
void 
glm_ivec2_mulsubs(const ivec2 a, int s, ivec2 dest) {
  dest[0] -= a[0] * s;
  dest[1] -= a[1] * s;
}
...
CGLM_INLINE 
void 
glm_ivec2_maxsub(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] -= glm_imax(a[0], b[0]);
  dest[1] -= glm_imax(a[1], b[1]);
}
...
CGLM_INLINE 
void 
glm_ivec2_minsub(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] -= glm_imin(a[0], b[0]);
  dest[1] -= glm_imin(a[1], b[1]);
}
...
CGLM_INLINE
int
glm_ivec2_distance2(const ivec2 a, const ivec2 b) {
  int xd, yd;
  xd = a[0] - b[0];
  yd = a[1] - b[1];
  return xd * xd + yd * yd;
...
CGLM_INLINE
float
glm_ivec2_distance(const ivec2 a, const ivec2 b) {
...
CGLM_INLINE
bool
glm_ivec2_eq(const ivec2 v, int val) {
...
CGLM_INLINE
bool
glm_ivec2_eqv(const ivec2 a, const ivec2 b) {
  return a[0] == b[0]
         && a[1] == b[1];
}
...
CGLM_INLINE
void
glm_ivec2_maxv(const ivec2 a, const ivec2 b, ivec2 dest) {
...
CGLM_INLINE
void
glm_ivec2_minv(const ivec2 a, const ivec2 b, ivec2 dest) {
  dest[0] = a[0] < b[0] ? a[0] : b[0];
  dest[1] = a[1] < b[1] ? a[1] : b[1];
}
...
CGLM_INLINE
void
glm_ivec2_abs(const ivec2 v, ivec2 dest) {
  dest[0] = abs(v[0]);
  dest[1] = abs(v[1]);
}
