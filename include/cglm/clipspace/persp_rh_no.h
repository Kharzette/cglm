...
CGLM_INLINE
void
glm_persp_decomp_rh_no(const mat4 proj,
...
CGLM_INLINE
void
glm_persp_decompv_rh_no(const mat4 proj, float dest[6]) {
...
CGLM_INLINE
void
glm_persp_decomp_x_rh_no(const mat4 proj,
                         float * __restrict left,
                         float * __restrict right) {
...
CGLM_INLINE
void
glm_persp_decomp_y_rh_no(const mat4 proj,
                         float * __restrict top,
                         float * __restrict bottom) {
...
CGLM_INLINE
void
glm_persp_decomp_z_rh_no(const mat4 proj,
                      float * __restrict nearZ,
                      float * __restrict farZ) {
  float m32, m22;
...
CGLM_INLINE
void
glm_persp_decomp_far_rh_no(const mat4 proj, float * __restrict farZ) {
...
CGLM_INLINE
void
glm_persp_decomp_near_rh_no(const mat4 proj, float * __restrict nearZ) {
...
CGLM_INLINE
void
glm_persp_sizes_rh_no(const mat4 proj, float fovy, vec4 dest) {
...
CGLM_INLINE
float
glm_persp_fovy_rh_no(const mat4 proj) {
...
CGLM_INLINE
float
glm_persp_aspect_rh_no(const mat4 proj) {
