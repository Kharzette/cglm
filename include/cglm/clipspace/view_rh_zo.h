...
CGLM_INLINE
void
glm_lookat_rh_zo(const vec3 eye, const vec3 center, const vec3 up, mat4 dest) {
...
CGLM_INLINE
void
glm_look_rh_zo(const vec3 eye, const vec3 dir, const vec3 up, mat4 dest) {
...
CGLM_INLINE
void
glm_look_anyup_rh_zo(const vec3 eye, const vec3 dir, mat4 dest) {
