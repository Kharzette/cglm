...
CGLM_INLINE
void
glms_vec3_(pack)(vec3s dst[], const vec3 src[], size_t len) {
  size_t i;
...
CGLM_INLINE
void
glms_vec3_(unpack)(vec3 dst[], const vec3s src[], size_t len) {
  size_t i;
...
CGLM_INLINE
float
glms_vec3_(dot)(const vec3s a, const vec3s b) {
...
CGLM_INLINE
float
glms_vec3_(norm2)(const vec3s v) {
...
CGLM_INLINE
float
glms_vec3_(norm_one)(const vec3s v) {
...
CGLM_INLINE
float
glms_vec3_(norm_inf)(const vec3s v) {
...
CGLM_INLINE
vec3s
glms_vec3_(add)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(adds)(const vec3s a, float s) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(sub)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(subs)(const vec3s a, float s) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(mul)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(scale)(const vec3s v, float s) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(scale_as)(const vec3s v, float s) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(div)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(divs)(const vec3s a, float s) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(addadd)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(subadd)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(muladd)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(muladds)(const vec3s a, float s, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(maxadd)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(minadd)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(subsub)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(addsub)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(mulsub)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(mulsubs)(const vec3s a, float s, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(maxsub)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(minsub)(const vec3s a, const vec3s b, vec3s dest) {
...
CGLM_INLINE
vec3s
glms_vec3_(cross)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(crossn)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
float
glms_vec3_(angle)(const vec3s a, const vec3s b) {
...
CGLM_INLINE
vec3s
glms_vec3_(rotate_m4)(const mat4s m, const vec3s v) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(rotate_m3)(const mat3s m, const vec3s v) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(proj)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(center)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
float
glms_vec3_(distance)(const vec3s a, const vec3s b) {
...
CGLM_INLINE
float
glms_vec3_(distance2)(const vec3s a, const vec3s b) {
...
CGLM_INLINE
vec3s
glms_vec3_(maxv)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(minv)(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(ortho)(const vec3s v) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(lerp)(const vec3s from, const vec3s to, float t) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(lerpc)(const vec3s from, const vec3s to, float t) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(mix)(const vec3s from, const vec3s to, float t) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(mixc)(const vec3s from, const vec3s to, float t) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(step_uni)(float edge, const vec3s x) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(step)(const vec3s edge, const vec3s x) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(smoothstep_uni)(float edge0, float edge1, const vec3s x) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(smoothstep)(const vec3s edge0, const vec3s edge1, const vec3s x) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(smoothinterp)(const vec3s from, const vec3s to, float t) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_vec3_(smoothinterpc)(const vec3s from, const vec3s to, float t) {
  vec3s r;
...
CGLM_INLINE
vec3s
glms_cross(const vec3s a, const vec3s b) {
  vec3s r;
...
CGLM_INLINE
float
glms_dot(const vec3s a, const vec3s b) {
...
CGLM_INLINE
vec3s
glms_vec3_(swizzle)(const vec3s v, int mask) {
  vec3s dest;
