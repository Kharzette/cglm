...
CGLM_INLINE
void
glms_persp_decomp_lh_zo(const mat4s proj,
...
CGLM_INLINE
void
glms_persp_decompv_lh_zo(const mat4s proj, float dest[6]) {
...
CGLM_INLINE
void
glms_persp_decomp_x_lh_zo(const mat4s proj,
...
CGLM_INLINE
void
glms_persp_decomp_y_lh_zo(const mat4s proj,
...
CGLM_INLINE
void
glms_persp_decomp_z_lh_zo(const mat4s proj,
...
CGLM_INLINE
void
glms_persp_decomp_far_lh_zo(const mat4s proj, float * __restrict farZ) {
...
CGLM_INLINE
void
glms_persp_decomp_near_lh_zo(const mat4s proj, float * __restrict nearZ) {
...
CGLM_INLINE
float
glms_persp_fovy_lh_zo(const mat4s proj) {
...
CGLM_INLINE
float
glms_persp_aspect_lh_zo(const mat4s proj) {
...
CGLM_INLINE
vec4s
glms_persp_sizes_lh_zo(const mat4s proj, float fovy) {
  vec4s dest;
