...
CGLM_INLINE
mat4s
glms_lookat_lh_zo(const vec3s eye, const vec3s center, const vec3s up) {
  mat4s dest;
...
CGLM_INLINE
mat4s
glms_look_lh_zo(const vec3s eye, const vec3s dir, const vec3s up) {
  mat4s dest;
...
CGLM_INLINE
mat4s
glms_look_anyup_lh_zo(const vec3s eye, const vec3s dir) {
  mat4s dest;
