...
CGLM_INLINE
vec4s
glms_vec4(const vec3s v3, float last) {
  vec4s r;
...
CGLM_INLINE
vec3s
glms_vec4_(copy3)(const vec4s v) {
  vec3s r;
...
CGLM_INLINE
vec4s
glms_vec4_(ucopy)(const vec4s v) {
  vec4s r;
...
CGLM_INLINE
void
glms_vec4_(pack)(vec4s dst[], const vec4 src[], size_t len) {
  size_t i;
...
CGLM_INLINE
void
glms_vec4_(unpack)(vec4 dst[], const vec4s src[], size_t len) {
  size_t i;
...
CGLM_INLINE
float
glms_vec4_(dot)(const vec4s a, const vec4s b) {
...
CGLM_INLINE
float
glms_vec4_(norm2)(const vec4s v) {
...
CGLM_INLINE
float
glms_vec4_(norm_one)(const vec4s v) {
...
CGLM_INLINE
float
glms_vec4_(norm_inf)(const vec4s v) {
...
CGLM_INLINE
vec4s
glms_vec4_(add)(const vec4s a, const vec4s b) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(adds)(const vec4s v, float s) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(sub)(const vec4s a, const vec4s b) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(subs)(const vec4s v, float s) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(mul)(const vec4s a, const vec4s b) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(scale)(const vec4s v, float s) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(scale_as)(const vec4s v, float s) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(div)(const vec4s a, const vec4s b) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(divs)(const vec4s v, float s) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(addadd)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(subadd)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(muladd)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(muladds)(const vec4s a, float s, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(maxadd)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(minadd)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(subsub)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(addsub)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(mulsub)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(mulsubs)(const vec4s a, float s, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(maxsub)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
vec4s
glms_vec4_(minsub)(const vec4s a, const vec4s b, vec4s dest) {
...
CGLM_INLINE
float
glms_vec4_(distance)(const vec4s a, const vec4s b) {
...
CGLM_INLINE
float
glms_vec4_(distance2)(const vec4s a, const vec4s b) {
...
CGLM_INLINE
vec4s
glms_vec4_(maxv)(const vec4s a, const vec4s b) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(minv)(const vec4s a, const vec4s b) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(lerp)(const vec4s from, const vec4s to, float t) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(lerpc)(const vec4s from, const vec4s to, float t) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(mix)(const vec4s from, const vec4s to, float t) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(mixc)(const vec4s from, const vec4s to, float t) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(step_uni)(float edge, const vec4s x) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(step)(const vec4s edge, const vec4s x) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(smoothstep_uni)(float edge0, float edge1, const vec4s x) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(smoothstep)(const vec4s edge0, const vec4s edge1, const vec4s x) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(smoothinterp)(const vec4s from, const vec4s to, float t) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(smoothinterpc)(const vec4s from, const vec4s to, float t) {
  vec4s r;
...
CGLM_INLINE
vec4s
glms_vec4_(swizzle)(const vec4s v, int mask) {
  vec4s dest;
