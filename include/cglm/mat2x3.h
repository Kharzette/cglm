...
CGLM_INLINE
void
glm_mat2x3_copy(const mat2x3 mat, mat2x3 dest) {
  dest[0][0] = mat[0][0];
  dest[0][1] = mat[0][1];
  dest[0][2] = mat[0][2];
...
CGLM_INLINE
void
glm_mat2x3_mul(const mat2x3 m1, const mat3x2 m2, mat2 dest) {
...
CGLM_INLINE
void
glm_mat2x3_mulv(const mat2x3 m, const vec3 v, vec2 dest) {
...
CGLM_INLINE
void
glm_mat2x3_transpose(const mat2x3 m, mat3x2 dest) {
