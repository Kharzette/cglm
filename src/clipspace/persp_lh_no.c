...
CGLM_EXPORT
void
glmc_persp_decomp_lh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decompv_lh_no(const mat4 proj, float dest[6]) {
  glm_persp_decompv_lh_no(proj, dest);
}

CGLM_EXPORT
void
glmc_persp_decomp_x_lh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_y_lh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_z_lh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_far_lh_no(const mat4 proj, float * __restrict farZ) {
  glm_persp_decomp_far_lh_no(proj, farZ);
}

CGLM_EXPORT
void
glmc_persp_decomp_near_lh_no(const mat4 proj, float * __restrict nearZ) {
  glm_persp_decomp_near_lh_no(proj, nearZ);
}

CGLM_EXPORT
void
glmc_persp_sizes_lh_no(const mat4 proj, float fovy, vec4 dest) {
  glm_persp_sizes_lh_no(proj, fovy, dest);
}

CGLM_EXPORT
float
glmc_persp_fovy_lh_no(const mat4 proj) {
  return glm_persp_fovy_lh_no(proj);
}

CGLM_EXPORT
float
glmc_persp_aspect_lh_no(const mat4 proj) {
