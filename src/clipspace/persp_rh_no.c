...
CGLM_EXPORT
void
glmc_persp_decomp_rh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decompv_rh_no(const mat4 proj, float dest[6]) {
  glm_persp_decompv_rh_no(proj, dest);
}

CGLM_EXPORT
void
glmc_persp_decomp_x_rh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_y_rh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_z_rh_no(const mat4 proj,
...
CGLM_EXPORT
void
glmc_persp_decomp_far_rh_no(const mat4 proj, float * __restrict farZ) {
  glm_persp_decomp_far_rh_no(proj, farZ);
}

CGLM_EXPORT
void
glmc_persp_decomp_near_rh_no(const mat4 proj, float * __restrict nearZ) {
  glm_persp_decomp_near_rh_no(proj, nearZ);
}

CGLM_EXPORT
void
glmc_persp_sizes_rh_no(const mat4 proj, float fovy, vec4 dest) {
  glm_persp_sizes_rh_no(proj, fovy, dest);
}

CGLM_EXPORT
float
glmc_persp_fovy_rh_no(const mat4 proj) {
  return glm_persp_fovy_rh_no(proj);
}

CGLM_EXPORT
float
glmc_persp_aspect_rh_no(const mat4 proj) {
