...
CGLM_EXPORT
void
glmc_quat_from_vecs(const vec3 a, const vec3 b, versor dest) {
...
CGLM_EXPORT
void
glmc_quat_axis(const versor q, vec3 dest) {
...
CGLM_EXPORT
void
glmc_quat_lerpc(const versor from, const versor to, float t, versor dest) {
  glm_quat_lerpc(from, to, t, dest);
}

CGLM_EXPORT
void
glmc_quat_nlerp(const versor from, const versor to, float t, versor dest) {
...
CGLM_EXPORT
void
glmc_quat_for(const vec3 dir, const vec3 up, versor dest) {
  glm_quat_for(dir, up, dest);
}

CGLM_EXPORT
void
glmc_quat_forp(const vec3 from, const vec3 to, const vec3 up, versor dest) {
